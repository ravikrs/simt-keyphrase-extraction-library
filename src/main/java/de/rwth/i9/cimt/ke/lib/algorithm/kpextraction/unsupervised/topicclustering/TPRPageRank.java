...
/**
 * PageRank implementation for TPR .
 * 
 * <p>
 ...
 * {@link TPRPageRank#MAX_ITERATIONS_DEFAULT}.
 * </p>
 * 
 * <p>
 ...
 * @since August 2016
 */
public final class TPRPageRank<V, E> implements VertexScoringAlgorithm<V, Double> {
	/**
	 ...
	 *            the input graph
	 */
	public TPRPageRank(Graph<V, E> g, Map<V, Double> initScore) {
		this(g, DAMPING_FACTOR_DEFAULT, MAX_ITERATIONS_DEFAULT, TOLERANCE_DEFAULT, initScore);
	}
	 ...
	 *            the damping factor
	 */
	public TPRPageRank(Graph<V, E> g, double dampingFactor, Map<V, Double> initScore) {
		this(g, dampingFactor, MAX_ITERATIONS_DEFAULT, TOLERANCE_DEFAULT, initScore);
	}
	 ...
	 */
	public TPRPageRank(Graph<V, E> g, double dampingFactor, int maxIterations, Map<V, Double> initScore) {
		this(g, dampingFactor, maxIterations, TOLERANCE_DEFAULT, initScore);
	}
	 ...
	 */
	public TPRPageRank(Graph<V, E> g, double dampingFactor, int maxIterations, double tolerance,
			Map<V, Double> initScore) {
		this.g = g;
		...
		run(dampingFactor, maxIterations, tolerance, initScore);
	}
	...
	private void run(double dampingFactor, int maxIterations, double tolerance, Map<V, Double> initScore) {
		// initialization
		Specifics specifics;
